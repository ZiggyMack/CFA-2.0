...
### **Bootstrap Recovery Process (90 minutes)**
...
6. **Authority:** What can you do without approval? *(Answer: Create, stage, coordinate)*

**If you can answer all 6:** Bootstrap successful ✅ → Continue to Default Priorities below
...
**Next:** Proceed to Priority 1 (Maintain System Integrity) below.

---

### **⚠️ Important Note for File Sharing**

When providing files to Ziggy (human coordinator):

**❌ NEVER use computer:// links**
- These only work within Claude's environment
- Ziggy cannot access /mnt/user-data/outputs/
- computer:// links appear broken to humans

**✅ ALWAYS provide files via:**
- Create file with `create_file` tool in working directory
- Upload to shared location accessible to both
- Use `str_replace` to edit existing files
- Stage in relay/ folders for review

**Example - WRONG:**
```
[Download your file](computer:///mnt/user-data/outputs/report.md)
```

**Example - RIGHT:**
```
I've created report.md in the auditors/relay/claude_incoming/ folder.
It's ready for your review in the GitHub repository.
```
