...
def render():
    ...
    # ========================================================================
    # NAVIGATION - 3 Buttons + Mr. Brute Doodle
    # ========================================================================
    nav_col1, nav_col2, nav_col3, nav_spacer, nav_brute = st.columns([1, 1, 1, 0.3, 0.5])
    ...
    with nav_brute:
        # Mr. Brute easter egg button - styled as doodle
