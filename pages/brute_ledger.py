...
def render():
    ...
    **Mr. Brute** is our accountability mechanism - a metaphor that personifies intellectual honesty:
    ...
    # Framework selection
    st.markdown("### Select Framework Audit:")
    ...
    with framework_tabs[2]:
        st.markdown("## Buddhism")
        st.markdown("*Non-theistic framework - Audit in Progress*")
        
        st.info("""
        ### 🔜 Coming Soon
        
        The Buddhism audit is currently in progress. This framework presents unique challenges:
        - Non-theistic worldview (no creator deity)
        - Emphasis on experiential verification
        - Complex relationship between metaphysics and practice
        
        **Expected completion**: Level 5 audit phase
        
        Want to contribute to this audit? Export your analysis from the Console and share with the community!
        """)
        ...
        col1, col2 = st.columns(2)
        with col1:
            st.markdown("### ✅ Potential Axioms")
            st.markdown("- Four Noble Truths")
            st.markdown("- Dependent Origination")
            st.markdown("- No-Self (Anatta)")
            st.markdown("- Impermanence (Anicca)")
            st.markdown("- *(Under review)*")
        with col2:
            st.markdown("### ⚠️ Potential Debts")
            st.markdown("- Rebirth mechanism")
            st.markdown("- Karma causation")
            st.markdown("- Nirvana ontology")
            st.markdown("- *(Under review)*")
    ...
    with framework_tabs[3]:
        st.markdown("## Stoicism")
        st.markdown("*Virtue ethics framework - Audit in Progress*")
        
        st.info("""
        ### 🔜 Coming Soon
        
        The Stoicism audit is currently in progress. This framework emphasizes:
        ...
        **Expected completion**: Level 5 audit phase
        ...
        with col1:
            st.markdown("### ✅ Potential Axioms")
            st.markdown("- Logos (rational order)")
            st.markdown("- Virtue = Eudaimonia")
            st.markdown("- Natural law ethics")
            st.markdown("- Cosmopolitanism")
            st.markdown("- *(Under review)*")
        with col2:
            st.markdown("### ⚠️ Potential Debts")
            st.markdown("- Fatalism tension")
            st.markdown("- Determinism vs responsibility")
            st.markdown("- Passion suppression costs")
            st.markdown("- *(Under review)*")
    ...
    with framework_tabs[4]:
        ...
        with col_action1:
            st.markdown("**Option 1: Load to Console**")
            ...
            if st.button("🔄 Load into Console", key="load_custom_btn"):
                ...
                st.success(f"✅ Ready for {target_framework}!")
                st.info("Go to Console → BFI section → Apply Custom")
