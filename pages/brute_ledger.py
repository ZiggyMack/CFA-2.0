...
def render():
    ...
    **Mr. Brute** is our accountability mechanism - a metaphor that personifies intellectual honesty:
    ...
    with framework_tabs[2]:
        ...
        st.markdown("---")
        st.markdown("### 📥 Save Your Framework")
        
        if st.button("💾 Export Custom Framework as JSON"):
            custom_framework = {
                "name": framework_name,
                "bf_i": {
                    "axioms": num_axioms,
                ...
                "admits_limits": True,
                "note": "Custom framework created in Brute Ledger. Edit lever scores in Console."
            }
            ...
            st.download_button(
                ...
                data=json_str,
                file_name=f"{framework_name.replace(' ', '_')}_brute_ledger.json",
            ...
            **Next steps:**
            ...
            2. Go to Console
            3. Use "Import JSON" to load it
            4. Adjust lever scores (0-10) for each dimension
            5. Export final audit with your scores
            """)
