...
def render():
    ...
    # ========================================================================
    # NAVIGATION - 3 Buttons (spaced like original) + Mr. Brute to the right
    # ========================================================================
    
    # Create layout: 3 buttons | spacer | Mr. Brute | spacer
    nav_col1, nav_col2, nav_col3, nav_spacer1, nav_brute, nav_spacer2 = st.columns([1, 1, 1, 0.5, 0.3, 2])
    ...
    with nav_brute:
        # Mr. Brute easter egg button - positioned to the right of main buttons
        if st.button("📓✍️", use_container_width=True, help="Mr. Brute's Ledger\n'To name your brute is to pay your fee'"):
